...
exports.PartitionKeyGenerators = {
    ...
    userId(requestEnvelope) {
        if (!(requestEnvelope
            ...
            throw (0, ask_sdk_core_1.createAskSdkError)('PartitionKeyGenerators', 'Cannot retrieve user id from request envelope!');
        }
    ...
    deviceId(requestEnvelope) {
        if (!(requestEnvelope
            ...
            throw (0, ask_sdk_core_1.createAskSdkError)('PartitionKeyGenerators', 'Cannot retrieve device id from request envelope!');
        }
