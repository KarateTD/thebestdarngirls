var inTheTheaters = [
  {
    ...
    "image":{
      ...
      "largeImageRul":"https://thebestdarngirls.s3.amazonaws.com/large-image/missionimpossiblereckoningpart1.jpeg"
    }
  },
  {
    "option":"2",
  ...
  {
    "option":"3",
    "mtitle":"Ruby Gillman, Teenage Kraken",
    "review":"Ruby Gillman lives with her parents, Agatha and Arthur, and her little brother, Sam. Ruby's parents only have one rule: Stay away from the ocean. This year junior prom will be on a boat with beautiful weather. Ruby creates a presentation to sway Agatha, but Agatha is immovable.<br/><br/>Ruby meets her friends, Trevin, Bliss, and Margot, at school and wants to form a solitary pact to throw an anti-prom. But they admit to having dates. They beg Ruby to reconsider attending prom, and she decides to lie to her mom and go. But now, Ruby needs a date. Ruby wants to pick her crush, Connor, and use her graphic calculator for a prom proposal. Margot tells Ruby not to give homework for prom and hands Ruby a confetti gun. Connor sees the confetti gun, it accidently goes off, and the glitter pushes him into the ocean. Ruby looks at the water for Connor, but he doesn't emerge. She takes a deep breath and jumps in to save him. Soon, Ruby is glowing and growing underwater. Ruby prepares to explain what's happening, but a new girl, Chelsea, claims to have rescued Connor. Chelsea is an instant sensation with Ruby's classmates, but Ruby flees because she can't stop glowing.<br/><br/>Ruby runs through town trying to hide, but Agatha spots her. Agatha gets in her car to drive to Ruby and hits something in the road. She stops to help and discovers it's her brother, Brill. Their mother heard about Ruby's transformation in the ocean and now wants to meet her granddaughter. Agatha says no and drives to Ruby. Agatha helps Ruby relax and transform. They go home, and Agatha tells Ruby the truth. Ruby is a Kraken. Ruby runs to her room but overhears Agatha and Brill talking about Ruby's grandmother and other secrets. Ruby chooses to find her grandmother and learn everything. Ruby will uncover a war, her powers, and her strength, but she must release the Kraken.<br/><br/>This film is a magical look at teenage life. Ruby must find her identity in high school with a changing body. Ruby still wants a friend to understand her as she navigates uncharted waters. She instantly connects to Chelsea, a mermaid in disguise. This film connects with adults and teens on humor and compassion level. The plot finds joy in the awkward moment and humanity in the sad. Enjoy this movie in the theaters to marvel at its wonder.<br/><br/>3.5 out of 5 stars.",
    "image":{
      "smallImageUrl":"https://thebestdarngirls.s3.amazonaws.com/small-image/rubygillmanteenagekraken.jpeg",
      "largeImageUrl":"https://thebestdarngirls.s3.amazonaws.com/large-image/rubygillmanteenagekraken.jpeg"
    }
  },
  {
    "option":"4",
