var inTheTheaters = [
  ...
  },
  {
    "option":"2",
    "mtitle":"Cats",
    "review":"Victoria is a young kitten abandoned by her owners and left in an ally. The Jellicle tribe takes interest in Victoria and they tell Victoria about the Jellicle Ball. Each cat performs for Old Deuteronomy cat and she picks someone to go to the Heaviside Layer for a new life. As talented cats start to disappear, who will win the Jellicle Ball?<br/><br/>Based on the stage musical Cats which derived from Old Possum’s Book of Practical Cats, the graphic and motion capture teams have done A+ work creating this film. Each cats’ essences, even down to the movement of their tails and their ears was perfectly in sync. The plot starts to slow down and the songs were not distinctive enough. The movie is fun at the movies with the whole family but only if you know the original play. Others will be lost in the plot.<br/><br/>3 out of 5 stars.",
    "image":{
