var inTheTheaters = [
  {
    "option":"1",
    "mtitle":"A Thousand and One",
    "review":"Inez paroles out of Rikers Island Correctional Facility in 1994 after spending one and a half years in prison for boosting. She returns to Brooklyn, enters a women's shelter, and does hair to make ends meet. Inez sees a young boy, Terry, across the street and recognizes him. Inez asks the boy if his foster mother treats him right. She promises Terry that she will never leave him again.<br/><br/>Inez sees Terry's friends while passing out flyers, but she doesn't see Terry. She questions his friends. And they tell her that Terry is in the hospital. He fell out of a window and hit his head. Inez runs to the hospital to check on him and gives him a gift. As they bond, she explains she is his mother. She lost him but will do everything to get him back. When he asks if she is returning, Inez asks Terry if he wants to say with her for a few days. She takes the boy and gets in a cab to Harlem. Inez is homeless with no job and a son to support alone. She wants to give Terry a better life than she did in foster care. But she must care for him without the city realizing Inez kidnapped Terry. Can Inez secretly provide her son with a life she never had?<br/><br/>Inez is a hurt woman with a chip on her shoulder. Inez will lash out for the slightest indiscretion, even when wrong. Each time Inez reacts, viewers get a glimpse into her tumultuous history. You will sit on the edge of your seat, wondering when this house of cards will come crashing down. And the audience will get the biggest shock when it does. It's up to you to determine if Inez is a mother who lost or a crook that won.<br/><br/>3.5 out of 5 stars.",
    "image":{
      "smallImageUrl":"https://thebestdarngirls.s3.amazonaws.com/small-image/athousandandone.jpeg",
      "largeImageUrl":"https://thebestdarngirls.s3.amazonaws.com/large-image/athousandandone.jpeg"
    }
  },
  {
    "option":"2",
  ...
  },
  {
    ...
    "image":{
      "smallImageUrl":"https://thebestdarngirls.s3.amazonaws.com/small-image/shazamfuryofthegods.jpg",
      "largeImageUrl":"https://thebestdarngirls.s3.amazonaws.com/large-image/shazamfuryofthegods.jpg"
    }
  },
  {
    "option":"4",
    "mtitle":"65",
    "review":"Pilot Mills, from Planet Somaris, embarks on a 2-year exploratory mission in space. Typically, his missions last six weeks, but his daughter, Nevine, is ill, and this mission pays three times his salary. During the mission, Mills wakes up to sirens blaring because debris from a meteorite hit the ship, and the aircraft goes into manual mode. Mills crash lands on an unknown planet and assesses the damage. Everyone in cryosleep died, and several escape pods got damaged except for 2, which are missing. He decides to end his life but thinks about Nevine. Then, his detection device picks up a distress beacon from a cryopod. He finds a young girl, Koa, alive inside the pod, but it's failing. He walks Koa to his aircraft and notices a massively large footprint. He sees a reflection of light in the distance. His device says it's one of the missing escape pods, and the pod is 15 kilometers away.. Mills wants to take Koa to the escape pod and coordinate a rendezvous point for a rescue crew to find him. Mills doesn't know that the unknown planet is Earth - 65 million years ago.<br/><br/>Mills is a man facing an unfathomable situation. He is on a planet he doesn't know, with a kid who speaks a different language, and dinosaurs surround him. They deal with tar pits, quicksand, cave-ins, and a dislocated shoulder. The plot doesn't have unnecessary love stories, drama, or altruistic speeches. It's 15 minutes of setup followed by action. The director made a risky choice to display a portion of a fight scene between Mills and a dinosaur on the handheld device. Viewers got a 3D pixelated fight that amps the suspense. The plot reveals two other secrets: Mills's reason for wanting to end his life and a ticking clock. You may not want to buy this movie, but it's worth the price of admission and a few jump scares.<br/><br/>3.5 out of 5 stars.",
    "image":{
      "smallImageUrl":"https://thebestdarngirls.s3.amazonaws.com/small-image/65.jpeg",
      "largeImageUrl":"https://thebestdarngirls.s3.amazonaws.com/large-image/65.jpeg"
    }
  },
  {
    "option":"5",
    "mtitle":"Operation Fortune: Ruse de Guerre",
    "review":"Nathan gets a call from his superior. Thieves broke into a lab in Johannesburg and stole something worth $10 billion. However, they don't know what the thieves stole, but they call it 'The Handle.' Nathan must create a team and uncover the buyer, seller, and what the thieves stole. The fallout will be catastrophic if The Handle falls into the wrong hands. Nathan knows the best person for the job: Orson Fortune.<br/><br/>Nathan goes to Morocco to convince Orson to take the job. Nathan hired J.J. and Sarah. J.J. can do, fire, and drive anything. Sarah is a tech-savvy con artist. Orson asks if John is coming. Sadly, Mike, the leader of another team, poached John from Nathan. Nathan collected intel that the deal's broker is Greg, but Greg keeps the seller and the buyer apart. Greg's courier will bring the item to Madrid and give it to Greg.<br/><br/>Orson, Sarah, and J.J. cover the airport and spot the courier with an alligator case. However, something is off. Orson realizes someone is working their job at the airport. They grab the courier and the briefcase and pull them into a van. They open the case and find an encrypted hard drive. Sarah starts to clone it when the courier has a heart attack. He tells him where to meet Greg. If they don't deliver the drive, Greg will kill the courier's wife. The man dies, but Orson sees the second team. It's Mike's team.<br/><br/>Now, they are in a race to get to Greg. Luckily for them, Greg has a fascination with celebrities. And his favorite is Danny Francesco. Sarah discovers that Greg is having a charity auction on a boat. With Danny by their side, they will get an invite. They have to convince Danny to go. Then, they can find the buyer and seller, return the drive to their government, and save the world.<br/><br/>The opening sequence is a master's class in sound engineering because the action flows on beat with Nathan's footsteps down the hall. In Guy Ritchie form, the cast of characters gets a quick introduction and background. Then, you get steeped into a sexy and funny mystery with guns, explosions, and terrorists. This strategy worked for The Gentleman, but it falls incredibly flat here. This film follows this director's formula but is dull, unamusing, and unimaginative. This movie is for Netflix, not the big screen.<br/><br/>2.5 out of 5 stars.",
    "image":{
      "smallImageUrl":"https://thebestdarngirls.s3.amazonaws.com/small-image/operationfortunerusedeguerre.jpeg",
      "largeImageUrl":"https://thebestdarngirls.s3.amazonaws.com/large-image/operationfortunerusedeguerre.jpeg"
    }
  }
];
