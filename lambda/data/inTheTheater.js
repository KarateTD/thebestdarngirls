var inTheTheaters = [
  ...
  },
  {
    "option":"2",
    "mtitle":"Synchronic",
    "review":"Paramedics, Steve and Dennis, have known each other for decades but have very different lives.  Steve is a lady's man and spends every night with a different woman.  Dennis is a married father of two daughters, eighteen years apart.  His oldest daughter, Brianna, decided to live on campus. During a call, Steve and Dennis find two people going through O.Ds.  The police find a package for Synchronic on the scene.  Synchronic is the newest synthetic drug, and since it's new, it's legal.  As the days go by, Steve and Dennis see more Synchronic users. On one call, Steve talks to the patient, and she says Brianna is missing.  Her friend points to the last place Brianna was, and Steve sees an empty Synchronic packet. Dennis continues to work while looking for his daughter, and he notices Steve takes more medication every day. Dennis doesn't know Steve has an inoperable brain tumor on his pituitary gland, leaving it underdeveloped. With a new sense of life, Steve remembers the seller's name on the pack of Synchronic and buys it all.  When he leaves the store, a man offers triple to get his pills.  Steve refuses.  Later that night, Steve finds the man, Dr. Kermani, hiding in his home.  Dr. Kermani created the drug, but the user's age determines the effect. An older person toggle the timelines.  However, a younger person will fully exists in a different time but may not be able to return.  Steve believes this happened to Brianna. With his undeveloped pituitary gland, Steve decides to study how Synchronic works to get Brianna back.<br/><br/>Synchronic is a sci-fi thriller with funny social commentary and a new look at the buddy relationship. They are open and honest about the pain and downfalls.  It helps set up the connection between Brianna and Steve in the story. Each time travel will leave you wondering what will happen next and what he will learn with the trip.<br/><br/>3.5 out of 5 stars.",
    "image":{
      "smallImageUrl":"https://thebestdarngirls.s3.amazonaws.com/small-image/synchronic.jpg",
      "largeImageUrl":"https://thebestdarngirls.s3.amazonaws.com/large-image/synchronic.jpg"
    }
  },
  {
    "option":"3",
  ...
  {
    "option":"5",
    "mtitle":"The War with Grandpa",
    "review":"After several incidents, Sally leaves work early, drives to her father's, Ed, home, and asks him to live with her family. Sally and her husband, Arthur, have three children, Mia, Peter, and Jenny.  Sally and Arthur need to make room for Ed. Peter doesn't understand why he has to give up his room because Ed can stay in the attic.  Sally explains the stairs will be too much for Ed.  So, Peter will move, and that's final.  The next day, Peter's friends tell him he has rights, and he should fight for them. Peter's friends tell him to declare war to get his room back.  So, Peter writes a Declaration of War and slips it under Ed's door. It states Ed has 24 hours to vacate the room, or he will suffer the consequences. Twenty-four hours later, Peter makes the first strike.  After the second strike, Ed is ready for battle, but he calls Peter to make Rules of Engagement.  First, no collateral damage.  Second, no telling. Peter and Ed use tools, food, and their friends to fight the battle, but who will win the war.<br/><br/>Based on The War with Grandpa by Robert Kimmel Smith, this movie is full of hijinks and fun.  While the two go to war, they try to have peace talks along the way.  Whether it's with a neutral third party or on a boat, they do try to make peace.  However, Peter learns the cost of war and why war goes on for so long. The sweetest moment in this movie is during the war.  Ed discovers someone is bullying Peter, and during their war, Ed comes to his defense. This movie is clean fun for older kids and adults.<br/><br/>3.5 out of 5 stars.",
    "image":{
      "smallImageUrl":"https://thebestdarngirls.s3.amazonaws.com/small-image/thewarwithgrandpa.jpg",
      "largeImageUrl":"https://thebestdarngirls.s3.amazonaws.com/large-image/thewarwithgrandpa.jpg"
    }
  }
];
